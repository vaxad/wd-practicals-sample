...
export default function SearchBar() {
    ...
    function handleSubmit(e){
        ...
        setHistory((prev)=>[searchTxt,...prev])
        setSearchTxt("")
  ...
  return (
    <div className=' flex flex-row gap-4 py-2 px-2'>
        <input list='history' value={searchTxt} onChange={(e)=>{setSearchTxt(e.target.value)}} className=' py-2 px-4 rounded-full bg-slate-50 border-2 border-zinc-950 text-zinc-950 text-lg font-medium w-full' type="text" name="" id="" />
        <datalist id='history'>
        ...
        <button onClick={handleSubmit} className=' px-4 py-2 rounded-full font-bold text-xl bg-zinc-950 text-slate-50 hover:bg-slate-50 hover:text-zinc-950 transition-all border border-zinc-950'>Search</button>
        <button onClick={handleReset} className=' px-4 py-2 rounded-full font-bold text-xl bg-red-500 text-slate-50 hover:bg-slate-50 hover:text-red-500 transition-all border border-red-500'>Reset</button>
    </div>
  )
}
